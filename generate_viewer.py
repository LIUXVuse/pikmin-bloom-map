...
.form-row input, .form-row textarea {
  width: 100%; border: 1px solid #e5e7eb; border-radius: 7px; padding: 7px 10px;
  font-size: 0.83rem; outline: none; font-family: inherit; transition: border-color 0.15s;
}
...
<div id="board-modal">
  <div class="board-container">
    ...
    <div class="board-content">
      ...
      <div id="create-post-panel">
        ...
        <form id="create-post-form" onsubmit="return false">
          ...
          <div class="form-row">
            <label>好友代碼（選填）</label>
            <input id="create-fc" type="text" maxlength="20" placeholder="例：123456789">
          </div>
          <div class="form-row">
            <label>座標（選填）</label>
    ...
    <div class="board-footer">
      ...
      <button class="board-post-btn" onclick="openCreatePost()">✏️ 發文</button>
    </div>
  </div>
</div>
</body>
